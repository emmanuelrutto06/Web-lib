...
class Genre(models.Model):
    name = models.CharField(max_length=200, help_text="Input a book genre (e.g. Thriller,Horror,Historical,Romance,western,Bildungsroman etc.)")
...
class Language(models.Model):
    name = models.CharField(max_length=200,
                            help_text="Input the book's natural language (e.g. English, Chinese, Korean etc.)")
...
class Book(models.Model):
    ...
    summary = models.TextField(max_length=1000, help_text="Input the books summary")
